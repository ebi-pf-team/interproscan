...
public class CreateMatchDBFromOnion {
    ...
    private static final String MATCH_QUERY =
            "select p.md5 as protein_md5, " +
                    ...
                    "       inner join uniparc.protein@UAPRO p " +
                    "       on m.upi = p.upi " +
                    " where m.status = 'T' " +
...
//            SecondaryIndex<String, Long, BerkeleyMatch> secIDX = store.getSecondaryIndex(primIDX, String.class, "proteinMD5");
            ...
            if (store != null) {
                try {
                    ...
                    System.out.println("Unable to close the BereleyDB connection.");
                }
            }
            ...
            if (myEnv != null) {
                try {
                    ...
                    System.out.println("Unable to close the BereleyDB environment.");
                }
            }
