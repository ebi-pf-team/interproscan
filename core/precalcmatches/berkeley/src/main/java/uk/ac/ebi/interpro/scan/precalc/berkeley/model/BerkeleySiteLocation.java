 ...
 */
@Persistent
public class BerkeleySiteLocation implements Comparable<BerkeleySiteLocation>{
    ...
    public boolean equals(Object o) {
        ...
        BerkeleySiteLocation that = (BerkeleySiteLocation) o;
     ...
     */
    @Override
    public int compareTo(BerkeleySiteLocation that) {
