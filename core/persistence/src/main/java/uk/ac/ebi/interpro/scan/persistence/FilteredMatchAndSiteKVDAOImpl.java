...
public abstract class FilteredMatchAndSiteKVDAOImpl<T extends RawMatch, U extends Match, E extends RawSite, K extends Site>
        extends FilteredMatchKVDAOImpl <U, T> implements FilteredMatchAndSiteKVDAO<T, U, E, K> {

    private static final Logger LOGGER = Logger.getLogger(FilteredMatchAndSiteKVDAOImpl.class.getName());
     ...
     */
    public FilteredMatchAndSiteKVDAOImpl(Class<U> modelClass) {
        super(modelClass);
    }
