...
public class PrintsRawMatchDAOImpl extends RawMatchDAOImpl<PrintsRawMatch> implements PrintsRawMatchDAO {
    ...
    public Map<String, RawProtein<PrintsRawMatch>> getRawMatchesForProteinIdsInRange(String bottomId, String topId, String signatureDatabaseRelease) {
        Map<String, RawProtein<PrintsRawMatch>> proteinIdToMatchMap =
                new HashMap<String, RawProtein<PrintsRawMatch>>();
        ...
        for (PrintsRawMatch match : resultList) {
            ...
            RawProtein<PrintsRawMatch> rawProtein = proteinIdToMatchMap.get(id);
            if (rawProtein == null) {
                rawProtein = new RawProtein<PrintsRawMatch>(id);
