...
public class RPSBlastFilteredMatchDAOImpl extends FilteredMatchDAOImpl<RPSBlastRawMatch, RPSBlastMatch> implements RPSBlastFilteredMatchDAO {

    private static final Logger LOGGER = Logger.getLogger(RPSBlastFilteredMatchDAOImpl.class.getName());

    private final String rpsBlastReleaseVersion;
     ...
     */
    public RPSBlastFilteredMatchDAOImpl(String version) {
        super(RPSBlastMatch.class);
        this.rpsBlastReleaseVersion = version;
    }
     ...
     */
    @Transactional
    public void persist(Collection<RawProtein<RPSBlastRawMatch>> rawProteins, Map<String, Signature> modelIdToSignatureMap, Map<String, Protein> proteinIdToProteinMap) {
        for (RawProtein<RPSBlastRawMatch> rawProtein : rawProteins) {
