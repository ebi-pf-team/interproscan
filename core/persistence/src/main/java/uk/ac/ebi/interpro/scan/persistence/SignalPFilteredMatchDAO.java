...
public interface SignalPFilteredMatchDAO extends FilteredMatchDAO<SignalPRawMatch, SignalPMatch> {
     ...
     */
    @Transactional
    void persist(Collection<RawProtein<SignalPRawMatch>> filteredProteins, Map<String, Signature> modelIdToSignatureMap, Map<String, Protein> proteinIdToProteinMap);
