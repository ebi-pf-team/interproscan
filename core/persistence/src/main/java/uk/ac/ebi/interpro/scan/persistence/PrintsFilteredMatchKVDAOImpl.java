...
public class PrintsFilteredMatchKVDAOImpl extends FilteredMatchKVDAOImpl<FingerPrintsMatch, PrintsRawMatch>
        implements FilteredMatchKVDAO<FingerPrintsMatch, PrintsRawMatch>{

    private static final Logger LOGGER = Logger.getLogger(PrintsFilteredMatchKVDAOImpl.class.getName());
     ...
     */
    public PrintsFilteredMatchKVDAOImpl() {
    ...
    public void persist(Collection<RawProtein<PrintsRawMatch>> filteredProteins, Map<String, Signature> modelIdToSignatureMap, Map<String, Protein> proteinIdToProteinMap) {
        ...
        for (RawProtein<PrintsRawMatch> rawProtein : filteredProteins) {
            ...
            Set<FingerPrintsMatch> filteredMatches =  new HashSet<>();
        ...
        if (filteredProteins.size() > 0) {
            ...
            addSignatureLibraryName(SignatureLibrary.PRINTS.getName());
        }
    }
