        ...
        <div class="prot_scale">
          <div class="bot-row">
                  ...
                  <div class="bot-row-line">
                       ...
                       <span class="scale_bar" style="left:${(scaleMarker?number / protein.length) * 100}%;" title="${scaleMarker}"></span>
                       <span class="scale_numb" style="left:${(scaleMarker?number / protein.length) * 100}%;">${scaleMarker}</span>
                       </#list>
                       </div>
             </div>
...
<#if protein.unintegratedSignatures??>
