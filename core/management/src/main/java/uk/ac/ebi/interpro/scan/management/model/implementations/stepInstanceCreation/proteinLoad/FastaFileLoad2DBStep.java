 ...
 * @since 1.0
 */
public class FastaFileLoad2DBStep extends Step implements StepInstanceCreatingStep {

    public static final String FASTA_FILE_PATH_KEY = "FASTA_FILE_PATH";

    private static final Logger LOGGER = Logger.getLogger(FastaFileLoad2DBStep.class.getName());
...
//                System.out.println(getTimeNow() + " Loading file " + providedPath);
                ...
                if (Files.exists(path)) {
                    ...
                    fastaFileInputStream = FastaFileLoad2DBStep.class.getClassLoader().getResourceAsStream(providedPath);
                }
                //TODO unit test
