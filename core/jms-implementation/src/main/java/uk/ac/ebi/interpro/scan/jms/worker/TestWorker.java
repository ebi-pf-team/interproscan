        ...
        try{
            ...
            while (running){
                ...
                if (requestMessage != null){   // receive has received a message before timing out.
                    ...
                    String messageString = "I am " + hostName + " and I received message: " + requestMessage.getText();
                    System.out.println("Sending message back to broker: " + messageString);
                    responseMessage = sessionHandler.createTextMessage(messageString);
