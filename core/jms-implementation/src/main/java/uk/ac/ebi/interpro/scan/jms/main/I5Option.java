...
public enum I5Option {
    ...
    INC_ANALYSES("incl-applications", "inclappl", false, "Optional, comma separated list of deprecated analyses that you want included.  If this option is not set, deprecated analyses will not run. ", "INC_ANALYSES", true, Mode.SET_OF_STANDARD_MODES),
    EXC_ANALYSES("excl-applications", "exclappl", false, "Optional, comma separated list of analyses you want to exclude.  ", "EXC_ANALYSES", true, Mode.SET_OF_STANDARD_MODES),
