...
public enum I5Option {
    ...
    INC_ANALYSES("incl-applications", "inclappl", false, "Optional, comma separated list of analyses.  If this option is not set, ALL analyses will be run. ", "INC_ANALYSES", true, Mode.SET_OF_STANDARD_MODES),
