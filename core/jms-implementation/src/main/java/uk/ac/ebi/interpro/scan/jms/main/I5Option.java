...
public enum I5Option {
    ...
    TSV_VERSION_OUTPUT("output-tsv-version", "vtsv", false, "Optional, includes a TSV version file along with any TSV output (when TSV output requested)", null, false, Mode.SET_OF_ALL_MODES),
