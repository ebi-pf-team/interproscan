...
class MobidbLite(object):
    ...
    def __init__(self, launchdir, _args):
        ...
        if self.args.fastaFile == '-':
            ...
            _, infile_extension = os.path.splitext(self.args.fastaFile)
            if infile_extension == '.gz':
                logging.debug('Opening Binary (gz \'ed) file, extension [%s]', infile_extension)
                self.instream = gzip.open(self.args.fastaFile, 'rt')
            else:
    ...
    def run(self):
        ...
        if self.args.outFile:
            ...
            if outfile_extension == '.gz':
                outstream = gzip.open(self.args.outFile, "wt")
            else:
