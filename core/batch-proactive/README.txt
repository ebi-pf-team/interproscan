                          InterProScan Batch ProActive
                          ----------------------------

  What is it?
  -----------

  InterProScan Batch ProActive contains ProActive Parallel Suite implementations of Spring Batch interfaces
  for the InterProScan project.
