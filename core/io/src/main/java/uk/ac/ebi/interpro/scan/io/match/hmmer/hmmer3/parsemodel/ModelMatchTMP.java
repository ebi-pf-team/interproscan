 ...
 * @since 1.0-SNAPSHOT
 */
public class ModelMatchTMP implements Serializable {
     ...
     * Group 4: UPI
     */
    public static final Pattern SEQUENCE_IDENTIFIER_lINE_PATTERN =
    ...
    public static final int MODEL_ID_GROUP = 4;
    ...
    public ModelMatchTMP(Matcher domainLineMatcher) {
        ...
        this.modelIdentifier = domainLineMatcher.group(MODEL_ID_GROUP);

    }
    public ModelMatchTMP(String  sequenceIdentifier, double eValue, double score, double bias) {
