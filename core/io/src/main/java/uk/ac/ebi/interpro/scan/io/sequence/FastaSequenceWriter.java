...
public final class FastaSequenceWriter implements SequenceWriter {
    ...
    @Override public void write(Collection<Protein> proteins, Resource resource) throws IOException {
        if (proteins == null)   {
    ...
    @Override public boolean isIdNullable() {
        return idNullable;
    }

    @Override public boolean isAddXrefs() {
        return addXrefs;
    }
