...
/**
 * Parser support class for PIRSF.
 *
 ...
 * @since 1.0-SNAPSHOT
 */
public class PirsfHmmer2ParserSupport implements Hmmer2ParserSupport<PIRSFHmmer2RawMatch> {
     ...
     */
    @Override
    public void addMatch(Hmmer2HmmPfamSearchRecord methodMatches, Map<String, RawProtein<PIRSFHmmer2RawMatch>> rawResults) throws IOException {
