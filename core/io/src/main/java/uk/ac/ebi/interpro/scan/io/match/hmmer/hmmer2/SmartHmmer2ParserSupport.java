 ...
 * @since 1.0-SNAPSHOT
 */
public class SmartHmmer2ParserSupport implements Hmmer2ParserSupport<SmartRawMatch> {
     ...
     */
    @Override
    public void addMatch(Hmmer2HmmPfamSearchRecord methodMatches, Map<String, RawProtein<SmartRawMatch>> rawResults) throws IOException {
