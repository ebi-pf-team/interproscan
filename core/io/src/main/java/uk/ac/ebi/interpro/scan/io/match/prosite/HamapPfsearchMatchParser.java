...
/**
 * Concrete parser for HAMAP (PfSearch) matches.
 *
 * @author Gift Nuka
 */
public class HamapPfsearchMatchParser extends PrositePfsearchMatchParser {

    public HamapPfsearchMatchParser(String signatureLibraryRelease) {
