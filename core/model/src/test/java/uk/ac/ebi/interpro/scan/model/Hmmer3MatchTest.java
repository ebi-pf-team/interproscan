...
public class Hmmer3MatchTest extends AbstractXmlTest<Protein> {
    ...
    public void init() {
        originalLocation = 
                new Hmmer3Match.Hmmer3Location(3, 107, 3.0, 3.7e-9, 1, 104, HmmBounds.N_TERMINAL_COMPLETE, 1, 2, false);
    ...
    public void testLocationEquals() {
        ...
        assertEquals("Original should equal itself", original, original);
        assertEquals("Original and copy should be equal", original, copy);
        copy = new Hmmer3Match.Hmmer3Location(1, 2, 3, 4, 5, 6, HmmBounds.COMPLETE, 7, 8, false);
