...
public final class RawProteinTest extends TestCase {
    ...
    public void testGetMatches() {
        ...
        // Add matches
        protein.addMatch(new ProDomRawMatch(PROTEIN_ID, "PD400414", "2006.01", 1, 198, "U689_HUMAN_Q6UX39", 1, 206, 426, 1E-41, 3, "PRECURSOR SIGNAL UNQ689/PRO1329 HOMOLOG DIRECT SEQUENCING EO-017 SECRETED", 206));
        protein.addMatch(new ProDomRawMatch(PROTEIN_ID, "PD400414", "2006.01", 1, 212, "U689_HUMAN_Q6UX39", 1, 206, 501, 2E-50, 3, "PRECURSOR SIGNAL UNQ689/PRO1329 HOMOLOG DIRECT SEQUENCING EO-017 SECRETED", 206));
        protein.addMatch(
