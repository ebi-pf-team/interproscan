...
public class Hmmer2Match extends HmmerMatch<Hmmer2Match.Hmmer2Location> {
    ...
    public static class Hmmer2Location extends HmmerLocation<Hmmer2Location.Hmmer2LocationFragment> {
        ...
        public Hmmer2Location(int start, int end, double score, double evalue,
            ...
            super(new Hmmer2LocationFragment(start, end), score, evalue, hmmStart, hmmEnd, hmmBounds);
        }

        public Hmmer2Location(int start, int end, double score, double evalue,
                              int hmmStart, int hmmEnd, int hmmLength) {
            super(new Hmmer2LocationFragment(start, end), score, evalue, hmmStart, hmmEnd, hmmLength);
        }
