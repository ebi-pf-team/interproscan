 ...
 * @since 1.0-SNAPSHOT
 */
public class BerkeleyPrecalculatedProteinLookupV2 implements PrecalculatedProteinLookup, Runnable {

    Logger LOGGER = Logger.getLogger(BerkeleyPrecalculatedProteinLookupV2.class.getName());
...
//    private Set<Protein> proteinsWithoutLookupHit;
    ...
    public BerkeleyPrecalculatedProteinLookupV2() {


    }

    public BerkeleyPrecalculatedProteinLookupV2(List<Protein> proteins,  Map <String, Long> proteinRanges, ProteinDAO proteinDAO,  LookupStoreToI5ModelDAO lookupStoreToI5ModelDAO, MatchHttpClient preCalcMatchClient) {
    ...
    public void run() {
        ...
        final  Set<Protein> proteinsAwaitingPersistence = new HashSet<>();
